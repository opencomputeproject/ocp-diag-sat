...
bool AdlerChecksum::Equals(const AdlerChecksum &other) const {
  return ((a1_ == other.a1_) && (a2_ == other.a2_) && (b1_ == other.b1_) &&
          (b2_ == other.b2_));
}
...
#define rDI "%%rdi"
  ...
  asm volatile(
      ...
      "), %%xmm0;"
      "movdqu   4(" rSI
      "), %%xmm1;"  // Be careful to use unaligned move here.
      "movdqa  16(" rSI
      "), %%xmm2;"
      "movdqu  20(" rSI
      "), %%xmm3;"
      ...
      "movdqa  0(" rSI
      "), %%xmm0;"  // Copy next 4-words to XMM0 and to XMM1.

      "movdqa  0(" rSI
      "), %%xmm5;"                     // Accomplish movdqu 4(%rSI) without
      "pshufd $0x39, %%xmm5, %%xmm1;"  // indexing off memory boundary.

      "movntdq %%xmm0,  0(" rDI
      ");"  // Copy 4-words to destination.
      "andps  32(" rAX
      "), %%xmm0;"
      "andps  32(" rAX
      "), %%xmm1;"
      ...
      : "S"(srcmem64), "D"(dstmem64), "a"(checksum_arr),
        "c"(num_of_48_byte_units), "d"(remaining_words));  // asm.

  if (checksum != NULL) {
    checksum->Set(checksum_arr[0], checksum_arr[1], checksum_arr[2],
                  checksum_arr[3]);
  }
  ...
  return true;
    ...
    defined(STRESSAPPTEST_CPU_ARMV7A) && defined(__ARM_NEON__)
...
#define crc_r "r6"
  ...
  volatile uint64 checksum_arr[] __attribute__((aligned(16))) = {1, 1, 0, 0};
  ...
  asm volatile(
      ...
      // Copy it.
      "ld1 {v8.2d, v9.2d, v10.2d, v11.2d}, [" src_r
      "], #64;\n"
      "st1 {v8.2d, v9.2d, v10.2d, v11.2d}, [" dst_r
      "], #64;\n"
      ...
      : [src] "r"(src), [dst] "r"(dst), [blocks] "r"(blocks),
        [crc] "r"(checksum_arr)
      : "memory", "cc", src_r, dst_r, blocks_r, crc_r, "v0", "v1", "v8", "v9",
        "v10", "v11", "v12", "v13", "v14", "v15", "v16");  // asm.
#else
  asm volatile(
      "mov " src_r
      ", %[src];	 	\n"
      ...
      : [src] "r"(src), [dst] "r"(dst), [blocks] "r"(blocks),
        [crc] "r"(checksum_arr)
      : "memory", "cc", "r3", "r4", "r5", "r6", "q0", "q1", "q8", "q9", "q10",
        "q11", "q12", "q13", "q14", "q15");  // asm.
#endif
